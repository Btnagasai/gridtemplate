        ...
        <div className="grid grid-cols-4  gap-4  ">
            {/* first grid */}
              ...
              <div className="text-[25px] font-normal pt-5">optimize not timings to content publish </div>
                ...
                {/* seven grid */}
                <div className="bg-white text-balance  text-center rounded-2xl "><span className="text-[55px] text-center font-bold">&#62;56%</span><br/> footer audience growth <img src="/assets/illustration-audience-growth.webp" alt="" className="w-[280px] h-[124px] ml-10"/> </div>
                <div className="bg-[#7651dc] col-span-2 p-4  text-[30px]  font-bold text-white rounded-2xl"><span className="grid grid-cols-2 items-center justify-center "><img src="/assets/illustration-grow-followers.webp" alt="" className="w-[250px] h-[200px]" />
