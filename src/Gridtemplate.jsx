const Gridtemplate = () =>{
    return(
        ...
        <div className="grid grid-cols-4  gap-4  ">
            {/* first grid */}
              <div className="bg-[rgb(250,238,226)]  text-[45px] font-dm font-bold row-span-2 rounded-2xl p-5 " ><div>Create and schedule content</div>
              <i className="text-[#7651dc] ">quicker</i>
               <img src="/assets/illustration-create-post.webp" alt="create button" />
               </div> 
                 {/* second grid */}
              <div className="bg-[#7651dc] col-span-2  text-wrap font-bold font-dm  text-white text-[65px] text-center rounded-2xl p-16">Social Media 
                <span className="text-[#ffcc69] font-dm">10x</span> Faster with AI
              ...
              <div className="text-[30px] font-dm font-semibold  pt-5">optimize not timings to content publish </div>
                ...
                <img src="/assets/sixth.png" alt="" className=" w-60 ml-5"/></div>
                    {/* sixth grid */}
               
                <div className="bg-[#ffcc69] text-balance font-dm text-left text-[45px] font-bold row-span-2 p-5 grid gap-5 rounded-2xl">Write your content using AI.
                <img src="/assets/fourth.png" alt="user chat"  className="w-56 h-56 ml-[25px]  "/>
                </div>
                {/* seven grid */}
                <div className="bg-white text-balance font-dm text-center rounded-2xl "><span className="text-[55px] text-center font-bold">&#62;56%</span><br/> footer audience growth <img src="/assets/illustration-audience-growth.webp" alt="" className="w-[280px] h-[124px] ml-10"/> </div>
